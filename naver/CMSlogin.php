...
if (isset($_SESSION['idx'])) {
  $query = "select count(*) from $table where idx = '{$_SESSION['idx']}'";
  $result = mysqli_fetch_array($conn->query($query), MYSQLI_BOTH);
  if($result[0]>0){
    exit_("이미 로그이 되어있습니다","/naver/CMS.php");
  }
}
...
<html lang="en" dir="ltr">
  ...
  <body>
    <div id="wrap">
      ...
      <div id="container">
        <div id="content">
          <form id="loginForm" name="loginForm" action="CMSloginSend.php" method="post">
            <input type="hidden" name="language" value="<?=$language?>">
            <div class="inputArea">
              <div class="inputRow">
                <input type="text" name="id" placeholder="<?=$id?>" maxlength="41">
              </div>
            </div>
            <div class="inputArea">
              <div class="inputRow">
